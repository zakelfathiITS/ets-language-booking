...
export function AccountScreen() {
  ...
  return (
    <>
      ...
      <div className="grid items-start gap-6 motion-safe:animate-rise lg:grid-cols-3">
        <ProfileSummary
          name={user.name}
          email={user.email}
          isAdmin={isAdmin}
        ...
        />
        <Card as="section" aria-labelledby="personal-information" className="lg:col-span-2">
          <Heading level={2}>
